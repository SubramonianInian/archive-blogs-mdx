...
| No.  | Questions                                                                       |
| ---- | ------------------------------------------------------------------------------- |
| 1    | <TableRow number="1" question="What is React?" />                               |   
| 2    | <TableRow number="2" question="What are the key features of React?" />          | 
| 3    | <TableRow number="3" question="How do you define a React component?" />          | 
| 4    | <TableRow number="4" question="What are props in React?" />                      | 
| 5    | <TableRow number="5" question="What is State in React?" />  
